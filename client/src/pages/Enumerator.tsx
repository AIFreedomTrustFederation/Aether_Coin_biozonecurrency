...
/**
 * Very simple Enumerator Dashboard
 *
 * This is a simplified dashboard that demonstrates the Enumerator pattern
 * without complex service architecture to ensure it works reliably
 */
const Enumerator: React.FC = () => {
  const [activeNodes, setActiveNodes] = useState<number>(42);
  const [lastUpdate, setLastUpdate] = useState<string>(new Date().toLocaleTimeString());
  
  // Simulate periodic updates to demonstrate the dynamic nature
  useEffect(() => {
    const timer = setInterval(() => {
      setActiveNodes(Math.floor(30 + Math.random() * 20)); // 30-50 nodes
        ...
        <div className="flex flex-col gap-6">
          ...
          <Card className="border-blue-200 dark:border-blue-900">
            <CardHeader className="pb-2">
              ...
              <CardDescription>
                From the FractalNetworkService background service
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="space-y-1">
                  ...
                  <div className="text-xl font-medium">{activeNodes}</div>
                </div>
                <div className="space-y-1">
                  <div className="text-sm text-muted-foreground">Average Latency</div>
                  <div className="text-xl font-medium">{Math.floor(50 + Math.random() * 100)} ms</div>
                </div>
                <div className="space-y-1">
                  <div className="text-sm text-muted-foreground">Throughput</div>
                  <div className="text-xl font-medium">{Math.floor(1000 + Math.random() * 4000).toLocaleString()} tx/s</div>
                </div>
              </div>
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div className="font-medium">Fractal Network Service</div>
