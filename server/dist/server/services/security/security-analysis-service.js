...
exports.securityAnalysisService = exports.SecurityAnalysisService = void 0;
/**
...
class SecurityAnalysisService {
     ...
     */
    async analyzeContract(contractCode, contractType = 'generic') {
        // Get security templates for the contract type
        const templates = await db_1.db.select().from(dapp_schema_1.securityAuditTemplates)
            .where((0, drizzle_orm_1.eq)(dapp_schema_1.securityAuditTemplates.category, contractType));
        // Run security checks
    ...
    async getSecurityTemplates() {
        return await db_1.db.select().from(dapp_schema_1.securityAuditTemplates);
    }
    /**
     ...
     */
    getVulnerabilityFixRecommendations(vulnerabilityId, contractCode) {
...
exports.securityAnalysisService = new SecurityAnalysisService();
