...
exports.gatewayValidationMiddleware = gatewayValidationMiddleware;
/**
 ...
 */
function gatewayValidationMiddleware(req, res, next) {
    ...
    const timestamp = parseInt(quantumTimestamp, 10);
