...
exports.useTokenManagement = exports.TokenManagementService = void 0;
...
class TokenManagementService {
     ...
     */
    async sendTokens(from, to, symbol, amount, options = { quantumSecured: true }) {
     ...
     */
    async participateInPresale(walletAddress, symbol, amount) {
        ...
        // Apply fractal validation
        const fractalValidated = this.quantumBridge.applyFractalValidation(signingResult.signature);
        if (!fractalValidated) {
            return {
                success: false,
     ...
     */
    async getTokenStatistics(symbol) {
     ...
     */
    async checkPresaleEligibility(walletAddress, symbol) {
    ...
    getPresaleContractAddress(symbol) {
    ...
    async getTokenPresalePrice(symbol) {
...
exports.useTokenManagement = useTokenManagement;
