...
class PushNotifications {
    ...
    constructor() {
        ...
        this.isAvailable = MobileFeatures_1.default.isPushNotificationsEnabled;
        this.init();
    }
    /**
    ...
    async subscribe() {
        ...
        try {
            ...
            const applicationServerKey = this.urlBase64ToUint8Array('BEl62iUYgUivxIkv69yViEuiBIa-Ib9-SkvMeAtA3LFgDzkrxZJjSgSnfckjBJuBkr3qBUYIHBQFLXYp5Nksh8U');
            // Subscribe to push notifications
...
exports.default = PushNotifications.getInstance();
