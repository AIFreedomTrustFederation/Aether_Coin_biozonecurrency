...
exports.useQuantumEditorBridge = exports.QuantumEditorBridge = void 0;
const quantumBridge_1 = require("../../quantum-security/lib/quantumBridge");
class QuantumEditorBridge {
    constructor() {
     ...
     */
    async validateSmartContract(code, language) {
     ...
     */
    injectQuantumResistance(code, language) {
        ...
        if (language === 'solidity') {
            ...
            if (!hasImport) {
                ...
                // Insert our import
                lines.splice(insertPos, 0, 'import "@fractalcoin/quantum-resistant/contracts/FractalQuantumVerifier.sol";');
            ...
            if (!inheritsVerifier) {
                ...
                if (contractMatch) {
                    ...
                    if (inheritanceList) {
                        ...
                        modifiedCode = modifiedCode.replace(contractRegex, `contract ${contractName} is FractalQuantumVerifier, ${inheritanceList} {`);
                    }
                    else {
                        // Create inheritance list with FractalQuantumVerifier
                        modifiedCode = modifiedCode.replace(contractRegex, `contract ${contractName} is FractalQuantumVerifier {`);
                    }
                }
            }
            ...
            if (!modifiedCode.includes('_validateQuantumSignature')) {
                ...
                for (const func of functionsToSecure) {
                    ...
                    modifiedCode = modifiedCode.replace(pattern, `$1\n        _validateQuantumSignature();`);
                }
            }
            return modifiedCode;
        }
     ...
     */
    highlightIssuesInEditor(editor, result) {
...
exports.QuantumEditorBridge = QuantumEditorBridge;
// React hook for using the Quantum Editor Bridge
const useQuantumEditorBridge = () => {
...
exports.useQuantumEditorBridge = useQuantumEditorBridge;
