...
exports.createBlockchainGateway = createBlockchainGateway;
...
const ServiceRegistrySchema = zod_1.z.object({
    serviceName: zod_1.z.string().min(3),
    serviceEndpoint: zod_1.z.string().url(),
    serviceType: zod_1.z.enum(['blockchain', 'storage', 'identity', 'governance', 'training', 'sharding', 'bridge']),
    blockchainType: zod_1.z.enum(['aethercoin', 'fractalcoin', 'filecoin', 'ethereum', 'other']).optional(),
    apiKey: zod_1.z.string().optional(),
    healthCheckPath: zod_1.z.string().optional().default('/health'),
...
const sql = (0, postgres_1.default)(config_1.DB_CONNECTION_STRING, { ssl: 'require' });
/**
 ...
 */
async function createBlockchainGateway() {
