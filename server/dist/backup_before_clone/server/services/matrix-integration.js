...
exports.matrixCommunication = void 0;
...
class MatrixCommunicationService {
    ...
    async sendMessage(payload) {
        try {
            ...
            if (this.client) {
                ...
                // Send message
                const result = await this.client.sendEvent(payload.roomId, 'm.room.message', messageContent, '');
     ...
     * @returns Room ID if successful, null otherwise
     */
    async createEscrowRoom(escrowId, sellerId, buyerId, roomName) {
        try {
            // In a real implementation, this would create an actual Matrix room
            // For now, we generate a simulated room ID
...
// Singleton instance
exports.matrixCommunication = new MatrixCommunicationService();
