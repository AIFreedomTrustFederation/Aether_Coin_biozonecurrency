...
const aiGuidance_1 = require("../services/aiGuidance");
...
router.post('/guidance', async (req, res) => {
    try {
        ...
        const validationResult = aiGuidance_1.aiGuidanceRequestSchema.safeParse(req.body);
        ...
        const guidanceResponse = await (0, aiGuidance_1.processAIGuidanceRequest)(validationResult.data);
