...
class SolanaBridge extends base_bridge_1.BaseBridge {
    constructor(bridgeId, config, rpcUrl, secretKey) {
    ...
    async initiateTransfer(details) {
        try {
            ...
            const txHash = `${crypto_1.default.randomBytes(32).toString('hex')}`;
