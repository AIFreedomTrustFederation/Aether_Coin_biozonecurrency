...
exports.CertificationCategory = exports.CertificationLevel = void 0;
exports.certifyBlockchain = certifyBlockchain;
exports.getCertificationGrade = getCertificationGrade;
...
})(CertificationCategory || (exports.CertificationCategory = CertificationCategory = {}));
/**
 ...
 */
function certifyBlockchain(params) {
...
function generateCertificationId(params) {
    ...
    return (0, crypto_1.createHash)('sha256').update(certData).digest('hex').substring(0, 16);
}
/**
 * Get a human-readable certification grade based on score
 */
function getCertificationGrade(score) {
    if (score >= 95)
        return 'A+';
    if (score >= 90)
        return 'A';
